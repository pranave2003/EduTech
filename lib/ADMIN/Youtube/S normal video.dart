...
class SNormal_video extends StatefulWidget {
  const SNormal_video({super.key});

  @override
  State<SNormal_video> createState() => _SNormal_videoState();
}

class _SNormal_videoState extends State<SNormal_video> {
  @override
